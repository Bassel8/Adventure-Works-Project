/****** This script is to create views with joins in the staging layer database to join some tables that will be tranferred later to the actual datawarehouse ******/
USE [ADV.Works_STG]
GO
/****** Object:  View [dbo].[Stg_view_Erp_Customer] ******/
--This view creates a join between Customer, Person and PersonAddress
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
  Create view [dbo].[Stg_view_Erp_Customer]
  as
...
GO
/****** Object:  View [dbo].[Stg_view_Erp_Employee] ******/
--This view creates a join between Employee, Person and EmployeeDepartmentHistory
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE view [dbo].[Stg_view_Erp_Employee]
as
...
Create View [dbo].[Stg_view_Erp_Product]
as
