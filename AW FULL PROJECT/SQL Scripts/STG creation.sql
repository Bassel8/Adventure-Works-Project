/****** This script it for creating the staging layer database, its tables and the schema for them ******/

USE [master]
GO
/****** Object:  Database [ADV.Works_STG] ******/
CREATE DATABASE [ADV.Works_STG]
...
/****** This script is to genrate a date column for when an new entry is inserted into the tables, and it is for troubleshooting porpuses, if any errors were encountered ******/
GO
...
USE [master]
GO
ALTER DATABASE [ADV.Works_STG] SET  READ_WRITE 
GO