/****** This script it for creating the datawarehouse, its tables and to establish relationships between them by refrencing all of the dim tables PKs as Fks in the fact tables (Surrogate keys) ******/
USE [master]
GO
/****** Object:  Database [ADV.Works_DW] ******/
CREATE DATABASE [ADV.Works_DW]

USE [ADV.Works_DW]
GO
/****** Object:  Table [dbo].[DimCurrency] NOT IN VIEWS******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[DimDate] NOT IN VIEWS AUTO GEN******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimSalesTerritory] NOT IN VIEWS******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactResellerSales] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactEmployeePay] ******/
...
/****** Creating surropgate keys in fact tables by refrencing the PKs of the dim tables ******/
